...
<form id="usuario_contraseña" name="usuario_contraseña" action="guardar_usu.php?op=1" method="post">
    ...
    <table class="tabla" align="center" width="500">
        <tr><td colspan="2" class="tdatos" align="center"><h3>DATOS DE LA PERSONA</h3></td></tr>
        <tr><td colspan="2" class="tdatos" align="center">
        ...
        <tr><td class="tdatos">Nombres:</td><td><input type="text" name="nom_personal" id="nom_personal" size="45" required/></td></tr>
        <tr><td class="tdatos">Apellido Paterno:</td><td><input type="text" name="paterno_personal" id="paterno_personal" size="45" required/></td></tr>
        <tr><td class="tdatos">Apellido Materno:</td><td><input type="text" name="materno_personal" id="materno_personal" size="45" required/></td></tr>
        <tr><td class="tdatos">Cedula de Identidad:</td><td><input type="text" name="ci_personal" id="ci_personal" size="45" required/></td></tr>
        ...
        <tr><td class="tdatos">Codigo de cargo:</td>
            <td><input type="text" name="cd_ubicacion" id="cd_ubicacion" size="45" onkeypress="return NumCheck(event, this)" required/></td>
        </tr>
        <tr><td class="tdatos">Cargo:</td><td><input type="text" name="cargo_personal" id="cargo_personal" size="45" required/></td></tr>
        <tr><td class="tdatos">Dirección:</td><td><input type="text" name="dir_personal" id="dir_personal" size="45" required/></td></tr>
        <tr><td class="tdatos">Telefono:</td><td><input type="text" name="fn_personal" id="fn_personal" size="45" onkeypress="return soloNumeros(event)" required></td></tr>
        <tr><td class="tdatos">Estado:</td><td><input type="radio" id="activo1" name="activo" value="true" checked>
                Activo
                &nbsp; 
        ...
        <center><table>
            <tr><td><input type="checkbox" id="usuario" name="usuario" style="height: 15px;width: 15px"></td>
            <td><h3>Usuario y Contraseña de Acceso al Sistema</h3></td></tr>
            </table>
        </center>
        </td>
        </tr>
...
<center>
    ...
    <table width="80%" height="55" style="border:1px;" align="center">
        <tr bgcolor='#CCCFF1'>
            ...
            <th class="colEnc">Código Ubicación Persona</th>
