...
<form id="usuario_contraseña" name="usuario_contraseña" action="modificar_usu.php?op=1" method="post">
    ...
    <?php
    $idpersonal=$_GET['id'];
    $consulta = "SELECT * FROM csa.personal WHERE id_personal='$idpersonal'";
    ...
    <table class="tabla" align="center" width="500">
        ...
        <tr><td class="tdatos">Área:</td>
            <td>
                <select id="id_area" name="id_area" style="height: 20px; width: 82%; text-align: center;" class="inputs" required>
                    ...
                    <?php
                    $consulta2 = "SELECT id_area, nom_area FROM csa.area where estado=true;";
        ...
        <tr>
            ...
            <td><input type="text" name="fn_personal" id="fn_personal" size="45" onkeypress="return soloNumeros(event)" value="<?php echo $fila["fn_personal"]; ?>" required></td>
        </tr>
        <tr>
