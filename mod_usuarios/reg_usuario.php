...
<center>
    ...
    <table width="90%" height="55" style="border:1px;" align="center">
        ...
        $consulta = "SELECT d.id_dpto, d.nom_dpto, a.cd_cnt_area, a.nom_area, p.id_personal, p.cd_ubicacion, p.ci_personal, p.paterno_personal, p.materno_personal, p.nom_personal, p.cargo_personal, p.dir_personal, p.fn_personal, case p.estado when true then 'ACTIVO' else 'NO ACTIVO' end estado, p.cd_ubi3 FROM csa.personal p, csa.departamento d, csa.area a WHERE d.id_dpto=a.id_dpto and a.id_area=p.id_area order by p.paterno_personal";
