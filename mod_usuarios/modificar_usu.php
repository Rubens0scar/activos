...
$db = Core::Conectar();
    ...
    $opcion = $_REQUEST["op"];
        ...
        try {
            $sql = "UPDATE csa.personal SET id_personal='$id_personal',id_area='$id_area',cd_ubicacion='$cd_ubicacion',cd_ubi3='$cd_ubi3',ci_personal='$ci_personal',nom_personal='$nom_personal',paterno_personal='$paterno_personal',materno_personal='$materno_personal',cargo_personal='$cargo_personal',dir_personal='$dir_personal',fn_personal='$fn_personal',estado='$estado' WHERE id_personal='$id_personal';";
            $datos = $db->query($sql);
