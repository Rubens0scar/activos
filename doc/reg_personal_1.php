...
<form id="usuario_contraseña" name="usuario_contraseña" action="guardar_usu.php?op=1" method="post">
    ...
    <table class="tabla" align="center" width="500">
        ...
        <tr>
            ...
            <td><input type="text" name="fn_personal" id="fn_personal" size="45" onkeypress="return soloNumeros(event)" required></td>
        </tr>
        <tr>
...
<center>
    ...
    <table width="90%" height="55" style="border:1px;" align="center">
        ...
        $consulta = "SELECT d.id_dpto, d.cd_cnt_dpto, d.nom_dpto, a.cd_cnt_area, a.nom_area, p.id_personal, p.cd_ubicacion, p.ci_personal, p.paterno_personal, p.materno_personal, p.nom_personal, p.cargo_personal, p.dir_personal, p.fn_personal, p.estado, p.cd_ubi3 
FROM csa.personal p, csa.departamento d, csa.area a 
WHERE p.estado=true and d.cd_cnt_dpto=a.id_dpto and a.id_area=p.id_area
order by p.paterno_personal";
        $resultado = $db->query($consulta);
        $i = 0;
        if ($resultado->rowCount()>0) {
            ...
            foreach ($resultado as $fila) {
                ...
                ?>
                    ...
                    <td align="center" class="colDat"><?php echo $fila["cd_cnt_dpto"];
        echo '.';
