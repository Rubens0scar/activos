...
$db = Core::Conectar();
 ...
 $consulta ="SELECT gam.gc_cnta_cm, gam.descripcion, gam.gc_cnta_sp, ri.id_act, ri.id_regind, extract(year from ra.fecha_compra::date) as anio, ra.fecha_compra, ac.nombre, ra.n_adjuntos, ri.descripcion_act, ri.costo, e.est_tec, ri.observaciones, p.nom_personal, p.paterno_personal, p.materno_personal, p.cargo_personal, p.cd_ubi3,  
case ra.estado 
