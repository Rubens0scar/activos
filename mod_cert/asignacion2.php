        ...
        <table id="resultado" class="display" width="90%" height="55" style="border:1px;" align="center">
            <thead>
                <tr bgcolor='#CCCFF1'>
                    ...
                    <th class="colEnc">ACTIVOS A TRANSFERIR</th>
                </tr>
            </thead>
            <tbody>
<?php
...
$id_transferente=$_GET["id_personal"];
...
WHERE p.estado=true and d.cd_cnt_dpto=a.id_dpto and a.id_area=p.id_area and p.id_personal!=$id_transferente
order by a.id_area";
...
?>
            ...
            <th align="center" class="colDat"><?php echo $i; ?></th>
                ...
                <th align="center" class="colDat"><?php
                    ...
                    ?></td>
                <th align="center" class="colDat"><?php echo "<a href='transferencia.php?id_personal=".$fila["id_personal"]."&id_personal2=".$id_transferente."'title='asignar'>TRANSFERIR</a>";  ?></th>
                </tr>
<?php
         }
 }
