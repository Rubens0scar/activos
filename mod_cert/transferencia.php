...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        <table><tr><td class="titulo">TRANSFERENCIA DE ACTIVOS</td></tr></table>
        ...
        <form action="transfiere_activo.php" method="post">
            <table id="resultado" class="display" width="90%" height="55" style="border:1px;" align="center">
                ...
                <tbody>
                    ...
                    $consulta = "SELECT ga.gc_cnta_sp, ri.id_act, ri.id_regind, a.nombre, ri.gestion, ri.descripcion_act, ri.marca, ri.modelo, ri.serie, e.est_tec, ri.observaciones, ra.n_adjuntos, ri.estado_asignacion, aa.id_personal
FROM csa.registro_individual ri, csa.activo a, csa.estado_activo e, csa.registro_activos ra, csa.gam ga, csa.asignacion_activos aa
WHERE ri.estado=true and ri.id_act=a.codigo and ri.estado_activo=e.id_estado and ri.id_regact=ra.id_regact and ra.id_cam=ga.id_gam and ri.id_regind=aa.id_regact and ri.estado_asignacion=1 and aa.id_personal='$id_transfiere' and aa.estado='true'
order by ri.id_regind";
                    ...
                    if ($resultado->rowCount() > 0) {
                        foreach ($resultado as $fila) {
                            ...
                            <tr>
                                ...
                                <th align="center" class="colDat"><?php echo "CSA-";
                echo $fila["gc_cnta_sp"];
                echo "-";
                echo $fila["id_act"];
                echo "-";
                echo $fila["id_regind"];
    ...
    ?>   
            ...
            <br><input type="submit" name="btntransferir" value="Asignar"/>
        </form>       
    </center>
