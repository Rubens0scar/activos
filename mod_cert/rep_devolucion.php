...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        ...
        <table><tr>
          <td class="titulo">Personal para Reporte de DEVOLUCIÓN de Activos</td>
        </tr>
...
order by a.id_area";
            ...
            echo $fila["cd_ubicacion"];
                        ?></th>
                           <th align="center" class="colDat"><?php echo "<a href='../mod_inicio/reportes.php?id_personal=" . $fila["id_personal"] . "&op=78 'title='transferencia'>REPORTE</a>"; ?></th>
                        </tr>
                        <?php
                    }
                }
