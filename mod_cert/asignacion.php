...
if ($_SESSION["usuario_nombre"]) {
   ...
   $(document).ready(function () {
    ...
    <center>
        ...
        <table><tr><td class="titulo">Personal para Asignación de Activos</td></tr></table><br>
...
order by a.id_area";
            ...
            echo $fila["cd_ubicacion"];
                        ?></th>
                            <th align="center" class="colDat"><?php echo "<a href='asigna.php?id_personal=" . $fila["id_personal"] . "'title='asignar'>ASIGNA</a>"; ?></th>
                        </tr>
                        <?php
                    }
                }
