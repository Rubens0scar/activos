...
<style>
    ...
    <center>
        ...
        <table><tr><td class="titulo">Personal para Asignación de Activos</td></tr>
...
?>
            ...
            <th align="center" class="colDat"><?php echo $i; ?></th>
                ...
                <th align="center" class="colDat"><?php
                    ...
                    ?></td>
                <th align="center" class="colDat"><?php echo "<a href='asigna.php?id_personal=".$fila["id_personal"]."'title='asignar'>ASIGNACIÓN</a>";  ?></th>
                </tr>
<?php
         }
 }
