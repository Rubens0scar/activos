...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        ...
        <table><tr><td class="titulo">Personal para Transferencia de Activos</td></tr></table><br>
...
order by a.id_area";
            ...
            echo $fila["cd_ubicacion"];
                        ?></th>
                           <th align="center" class="colDat"><?php echo "<a href='asignacion2.php?id_personal=" . $fila["id_personal"] . "'title='transferencia'>TRANSFERENCIA</a>"; ?></th>
                        </tr>
                        <?php
                    }
                }
