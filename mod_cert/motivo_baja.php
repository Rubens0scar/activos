...
?>
<form name="match_form" method="post" action="guardar.php?op=2">
    <center>
	...
	<div align="right"><a href="../mod_inicio/regsis.php"><img src="../theme/images/volver.jpg" width="30" height="30"/><strong>VOLVER</strong></a></div>
        ...
        <div id="nuevo" style="display: none;" class="estilo_subdiv">        
            ...
            <table>
                ...
                <tr><td>Motivo:</td><td><textarea name="motivo" id="motivo" rows="5" cols="40" ></textarea></td></tr>                
            </table>
            </center>
            <br>
            <center>
...
<?php
 $resultado ="SELECT id_motivo, motivo, case estado when true then 'ACTIVO' else 'NO ACTIVO' end estado FROM csa.motivo_baja order by id_motivo asc";
...
?>
            ...
            <td align="center" class="colDat"><a href="motivo_baja.php?id=<?php echo $fila["id_motivo"];?>"><img src="images/6.png" alt="" title="MODIFICAR" style="width: 20px; height: 20px"/></a></td>
...
<?php
    ...
    $id=$_REQUEST["id"];
    $resultado ="SELECT motivo, case estado when true then 1 else 0 end estado FROM csa.motivo_baja where id_motivo=$id";
    $resultado =$db->query($resultado);
    foreach($resultado as $fila){
        $motivo=$fila[0];
        $estado=$fila[1];
    ...
    <div class="estilo_div" >
        ...
        <div id="nuevo" class="estilo_subdiv">        
            ...
            <table>
                ...
                <tr style="height: 10px"><td></td><td></td></tr>
                <tr><td>Motivo:</td><td><textarea name="motivo" id="motivo" rows="5" cols="40" ><?=$motivo?></textarea></td></tr>
