...
<style>
  ...
  <table><tr><td class="titulo">DEVOLUCION DE ACTIVOS</td></tr></table>
        ...
        <form action="devuelve_activo.php" method="post">
...
WHERE ri.estado=true and ri.id_act=a.codigo and ri.estado_activo=e.id_estado and ri.id_regact=ra.id_regact and ra.id_cam=ga.id_gam and ri.id_regind=aa.id_regact and ri.estado_asignacion=1 and aa.id_personal='$id_pers' and aa.estado='true'
...
?>   
            ...
            <br>
            <input type="submit" name="btnasignar" value="Devuelve"/>
        </form>       
    </center>
