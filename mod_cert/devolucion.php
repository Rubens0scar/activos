...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        ...
        <table><tr><td class="titulo">Personal para Devolución de Activos</td></tr></table><br>
        ...
        <table id="resultado" class="display" width="90%" height="55" style="border:1px;" align="center">
            <thead>
                <tr bgcolor='#CCCFF1'>
                    ...
                    <th class="colEnc">Devoluciones</th>
                </tr>
            </thead>
            <tbody>
                <?php
...
order by a.id_area";
            ...
            echo $fila["cd_ubicacion"];
                        ?></th>                           
                            <th align="center" class="colDat"><?php echo "<a href='devuelve.php?id_personal=" . $fila["id_personal"] . "'title='devolucion'>DEVOLUCION</a>"; ?></th>
                        </tr>
                        <?php
                    }
                }
